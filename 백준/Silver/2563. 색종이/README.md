...
1. 100 * 100 짜리 배열 생성 (도화지) 
2. 입력 값 x, y가 있을 때 가로 세로가 10인 정사각형이니 색종이의 범위는 (x ~ x+10) , (y ~ y+10)
3. 배열에서 색종이가 속한 인덱스는 1 아닌 곳은 0
4. 배열에서 1의 개수를 구하면 색종이의 넓이
